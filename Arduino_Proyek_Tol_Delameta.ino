...
String lokasi = "Tegal";
String golongan; //String golongan = "";
...
void loop() {
  ...
  while(client.connected()) {       //Start client.connected()
    if(client.available()){         // Start client.avaliable()
      ...
      DynamicJsonDocument doc(capacity); // StaticJsonDocument<192> doc;
      DeserializationError error = deserializeJson(doc, getData); //const size_t capacity = JSON_OBJECT_SIZE(18) + 410;
      ...
      const char* tarif           = doc["tarif"]; // "2021-12-17 13:02:04"
       ...
       if(String(ambilStatus) == "Berhasil"){
          ...
          //POST TO SERIAL
          Serial.print("NomorRFID :");Serial.println(uidString);
